...
if (key_exists('cod', $_POST)) {
    ...
    trigger_error("Código do gasto não informado.", E_USER_ERROR);
}
...
if (key_exists('pagoem', $_POST) && strlen($_POST['pagoem']) > 0) {
    $pagoem = $_POST['pagoem'];
} else {
    $pagoem = '0000-00-00';
}
...
gasto_atualizar($cod, $gastoem, $observacao, $valor, $credor, $mp, $vencimento, $agrupador, $localizador, $pagoem, $observacao_pgto);
$despesa = despesa_detalhes($despesa);
$detalhesGasto = gasto_detalhes($cod);
?>

...
if(key_exists('agrupador', $_GET)){
    $agrupador = $_GET['agrupador'];
}else{
    trigger_error('Agrupador não informado.', E_USER_ERROR);
}

$receitas = receitas_listar('0000-00', '9999-12', '%', '%', PHP_INT_MIN, PHP_INT_MAX, '0000-00-00', '9999-12-31', $agrupador, '%');
$gastos = gastos_filtrar('0000-00', '9999-12', '0000-00-00', '9999-12-31', '0000-00-00', '9999-12-31', '0000-00-00', '9999-12-31', '%', '%', '%', '%', PHP_INT_MIN, PHP_INT_MAX, $agrupador, '%');
...
<nav class="breadcrumb">
    ...
    <a class="item" href="agrupadores.php">Agrupador</a>
    <a class="item"><?=$agrupador;?></a>
</nav>

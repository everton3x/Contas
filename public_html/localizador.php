...
if(key_exists('localizador', $_GET)){
    $localizador = $_GET['localizador'];
}else{
    trigger_error('Localizador não informado.', E_USER_ERROR);
}

$receitas = receitas_listar('0000-00', '9999-12', '%', '%', PHP_INT_MIN, PHP_INT_MAX, '0000-00-00', '9999-12-31', '%', $localizador);
$gastos = gastos_filtrar('0000-00', '9999-12', '0000-00-00', '9999-12-31', '0000-00-00', '9999-12-31', '0000-00-00', '9999-12-31', '%', '%', '%', '%', PHP_INT_MIN, PHP_INT_MAX, '%', $localizador);
...
<nav class="breadcrumb">
    ...
    <a class="item" href="localizadores.php">Localizador</a>
    <a class="item"><?=$localizador;?></a>
</nav>
